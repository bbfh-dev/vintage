...
> [!IMPORTANT]
> Check out the [Wiki](https://github.com/bbfh-dev/vintage/wiki) for information.
...
1. Minimum code abstraction.[⁽¹⁾](https://github.com/bbfh-dev/vintage/wiki/Philosophy#1-minimum-code-abstraction)
